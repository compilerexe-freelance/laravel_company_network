            ...
            <table class="table">
              ...
              <tbody>
                <form action="{{ url('admin/manage/category/update/'.$get_category->id) }}" method="post">
                  {{ csrf_field() }}
                  <tr>
                    <td class="align-middle table-none-border" style="color: red;">Edit Category Name</td>
                    <td class="table-none-border" style="color: red;">{{ $get_category->category_name }}</td>
                    <td class="table-none-border"></td>
                    <td class="table-none-border"></td>
                  </tr>

                  <tr>
                    <td class="align-middle table-none-border">Change Main Catagory</td>
                  ...
                  <tr>
                    ...
                    <td class="table-none-border"><input type="text" class="form-control" name="category_name" value=""></td>

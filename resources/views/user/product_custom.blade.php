          ...
          <div class="col-md-12 text-md-center">
            <div class="form-group">
              <table class="table table-bordered">
                <thead>
                  <tr>
                    <th class="text-md-center">สินค้า</th>
                ...
                <tbody>
                  ...
                  <tr class="table-success">
                    ...
                    <td class="align-middle">รวมราคา</td>
                    <td class="align-middle">12,500 Bath</td>
                    <td class="align-middle" colspan="2"><a href="{{ url('quotation/create') }}"><button type="button" class="btn btn-success"><i class="fa fa-shopping-cart fa-lg"></i> สร้างใบเสนอราคา</button></a></td>
                  </tr>
                </tbody>
              </table>
            </div>
